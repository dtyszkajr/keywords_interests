...
for page in didread:
    ...
    with open('websites_data/{}'.format(page['id']), 'r') as f:
        page_content = f.read()
    # parsing page code
...
with open('websites_data/links-page-types.csv', 'w') as f:
...
for prod in products:
    with open('websites_data/products/{}'.format(prod['id']), 'w') as f:
